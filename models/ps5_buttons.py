...
def ps5_buttons(bot, message, lang_code):
    ...
    button_connecting_ps4 = types.KeyboardButton(language_pack['button_connecting_ps5'])
    button_game_blocked = types.KeyboardButton(language_pack['button_game_blocked_ps5'])
    button_game_blocked_password = types.KeyboardButton(language_pack['button_game_blocked_password_ps5'])
    button_download_games = types.KeyboardButton(language_pack['button_download_games_p5'])
    ...
    ps4_gamepad = types.KeyboardButton(language_pack['ps5_gamepad'])
